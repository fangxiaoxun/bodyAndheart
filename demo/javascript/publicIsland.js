window.addEventListener('load', () => {
    ...
    const beforeData = ['../images1/mouseBefore_one.png', '../images1/mouseBefore_two.png', '../images1/mouseBefore_three.png', '../images1/mouseBefore_four.png']; //定义输出存储地鼠被打之前的图片
    const afterData = ['../images1/mouseAfter_one.png', '../images1/mouseAfter_two.png', '../images1/mouseAfter_three.png', '../images1/mouseAfter_four.png']; //定义输出存储地鼠被打之后的图片
    //点击开始按钮，生成地鼠，开始游戏
    ...
    let change = 1;
    let count = 0; //按压的次数
    const data = ['../images1/balloon_blue.svg', '../images1/balloon_green.svg', '../images1/balloon_orange.svg', '../images1/balloon_pink.svg', '../images1/balloon_yellow.svg', '../images1/balloon_red.svg', '../images1/balloon_purple.svg']; //数组存储气球的图片
    ...
    let chooseImg = ['../images1/game_two.png', '../images1/game_three.png', '../images1/game_four.png'];
    let choosePic = ['../images1/gameHoverTwo.png', '../images1/gameHoverThree.png', '../images1/gameHoverFour.png'];
    let chooseSmallPic = ['../images1/gameSmallTwo.png', '../images1/gameSmallThree.png', '../images1/gameSmallFour.png'];
    //调用手风琴效果函数
