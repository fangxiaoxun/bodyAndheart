window.addEventListener('load', () => {
    ...
    addAudio.addEventListener('click', () => {
        ...
        btn_record.children[0].src = '../images1/btn_record.png';
        finish_record.style.display = 'none';
        btn_record.addEventListener('click', () => {
            startRecording(); //录音
            btn_record.children[0].src = '../images1/btn_record.gif';
    ...
    const conchData = ['../images1/conchOne.png', '../images1/conchTwo.png', '../images1/conchThree.png', '../images1/conchFour.png']; //定义数组存储海螺图片
    ...
    function tabAudio(bubblesAudio, audio, i) {
        bubblesAudio[i].addEventListener('click', () => {
            if (bubblesAudio[i].children[0].src.match('play')) {
                bubblesAudio[i].children[0].src = '../images1/bubble_pause.png';
                audio.pause();
            } else {
                bubblesAudio[i].children[0].src = '../images1/bubble_play.png';
                audio.play();
                //若检测到音频播放完毕则停止播放音频
