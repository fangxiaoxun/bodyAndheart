window.addEventListener('load', () => {
    ...
    //调用点击选择，点击取消按钮函数
    btnSelect(btn_select, '../images1/btn_choose.png', '../images1/btn_none.png', 'btn_choose');
        ...
        ajax({
            ...
            success: function(result) { //返回接受信息
                for (let i = 0; i < result.data.posts.length; i++) {
                    ...
                    str += '    <!-- 点击查看更多按钮 -->';
                    str += '    <div class="more">';
                    str += '        <img src="../images1/more.png" alt="更多">';
                    ...
                    str += '    <!-- 拥抱 -->';
                    str += '    <div class="btn_hug"><img src="../images1/hug.png"><div class="countLove">0</div></div>';
